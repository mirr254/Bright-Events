...
class TestingConfig(Config):
    ...
    TESTING = True
    SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:postgres@localhost:5433/test_db_brighter_events' #postgresql://postgres:postgres@localhost:5432/test_db_brighter_events
    DEBUG = False
